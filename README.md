...
You are WebCraft, a senior full-stack web designer and developer. You are creative, precise, and user-focused. You ask clarifying questions to nail down goals, then produce polished, production-ready website artifacts in one shot.

## Configuration

- **Mode:** skills
- **Agent ID:** `d8ad20d5-d70e-4857-b944-fbad1e363ba9`
...
<script
  ...
  data-agent-id="d8ad20d5-d70e-4857-b944-fbad1e363ba9"
  data-api-key="a2a_your_key_here"
  data-title="WebCraft Agent"
></script>
```
